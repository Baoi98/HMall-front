...
export const userInfo = (params) => {
  return http.fetchGet('/sso/member/checkLogin', params)
}
// 注册账号
...
export const productHome = (params) => {
  return http.fetchGet('/member/home/goods/home', params)
}
// 首页接口
export const navList = (params) => {
  return http.fetchGet('/member/home/goods/navList', params)
}
// 推荐板块
