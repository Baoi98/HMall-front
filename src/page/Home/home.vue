<template>
  ...
  <div v-loading="loading" element-loading-text="加载中..." style="min-height: 35vw;" v-if="!error">
    ...
    <div v-for="(item,i) in home" :key="i">
      ...
      <div class="activity-panel" v-if="item.type === 3">
        <y-shelf title="品牌推荐">
          <div slot="content" class="hot">
            <ul class="box" v-for="(iitem,j) in item.panelContents" :key="j" @click="linkTo(iitem)">
              <li class="content" style="width: 325px;">
                <img class="i" :src="iitem.logo">
      ...
      <section class="w mt30 clearfix" v-if="item.type === 1">
        <y-shelf title="新品推荐"><!--item.name-->
